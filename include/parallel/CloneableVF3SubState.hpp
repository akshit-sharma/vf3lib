...
#ifndef CloneableVF3SubState_HPP
#define CloneableVF3SubState_HPP
...
class CloneableVF3SubState : public State
{
private:
...
public:
	...
	CloneableVF3SubState(
		...
		nodeID_t *order = NULL);
	CloneableVF3SubState(
		const CloneableVF3SubState &state, bool hard_copy = true);
	~CloneableVF3SubState();
...
/*----------------------------------------------------------
 * CloneableVF3SubState::CloneableVF3SubState(g1, g2)
...
CloneableVF3SubState<
	...
	CloneableVF3SubState(
		...
		uint32_t nclass,
		nodeID_t *order)
	: State(ag1->NodeCount(), ag2->NodeCount())
{
...
/*----------------------------------------------------------
 * CloneableVF3SubState::CloneableVF3SubState(state)
 * Copy constructor.
 ---------------------------------------------------------*/
template<
	typename Node1,
...
CloneableVF3SubState<
	...
	NodeComparisonFunctor,
	EdgeComparisonFunctor>::
	CloneableVF3SubState(const CloneableVF3SubState &state, bool hard_copy)
	: State(state)
{
	...
	if (hard_copy) {
		...
		std::memcpy(core_1, state.core_1, n1 * sizeof(nodeID_t));
		std::memcpy(core_2, state.core_2, n2 * sizeof(nodeID_t));
		std::memcpy(core_len_c, state.core_len_c, classes_count * sizeof(uint32_t));
		std::memcpy(dir, state.dir, n1 * sizeof(nodeDir_t));
		std::memcpy(predecessors, state.predecessors, n1 * sizeof(nodeID_t));
...
/*---------------------------------------------------------------
 * CloneableVF3SubState::~CloneableVF3SubState()
 * Destructor.
 --------------------------------------------------------------*/
template<
	typename Node1,
...
CloneableVF3SubState<
	...
	Edge2,
	NodeComparisonFunctor,
	EdgeComparisonFunctor>::~CloneableVF3SubState()
{
...
/*---------------------------------------------------------------
 * bool CloneableVF3SubState::IsFeasiblePair(node1, node2)
...
/*--------------------------------------------------------------
 * void CloneableVF3SubState::AddPair(node1, node2)
