...
VF3ParallelSubState<
	...
	Edge2,
	NodeComparisonFunctor,
	EdgeComparisonFunctor>::VF3ParallelSubState(const VF3ParallelSubState &state)
...
VF3ParallelSubState<
	...
	VF3ParallelSubState<
		...
		Edge2,
		NodeComparisonFunctor,
		EdgeComparisonFunctor>::operator=(const VF3ParallelSubState &state)
{
	if (this != &state) {
		core_1.empty();
		core_2.empty();
		...
		core_len_c.insert(
			core_len_c.begin(), state.core_len_c.begin(), state.core_len_c.end());
		predecessors.insert(
			predecessors.begin(),
			state.predecessors.begin(),
			state.predecessors.end());
