...
const uint64_t NULL_TRACE_ID =
	(std::numeric_limits<uint64_t>::max)(); /**<Null ID value */
...
public:
	...
	void CSVFlush()
	{
		output_stream << last_info.id << ";" << last_info.parent << ";"
									<< last_info.depth << ";" << last_info.descendants_count
