...
template<typename Node, typename Edge>
FastStreamARGLoader<Node, Edge>::FastStreamARGLoader(
	std::istream &in, bool undirected)
{
...
template<typename Node, typename Edge>
nodeID_t FastStreamARGLoader<Node, Edge>::GetOutEdge(
	nodeID_t node, uint32_t i, Edge *pattr)
{
