 ...
 */
template<typename Node, typename Edge> class NodeClassifier
{
protected:
...
public:
	 ...
	 */
	NodeClassifier(
		ARGraph<Node, Edge> *g, const NodeClassifier<Node, Edge> &classifier)
	{
		g1 = g;
	 ...
	 */
	uint32_t CountClasses() { return classmap.size(); }
