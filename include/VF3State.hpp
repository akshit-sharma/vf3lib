...
namespace vflib
{
	...
	template <typename Node1, typename Node2,
		...
		typename NodeComparisonFunctor, typename EdgeComparisonFunctor>
		VF3State<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>
		::VF3State(const VF3State &state):State(state)
	{
		g1 = state.g1;
		g2 = state.g2;
	...
	template <typename Node1, typename Node2,
		...
		EdgeComparisonFunctor>::UpdateTerminalSetSize(nodeID_t node, nodeID_t level, 
			bool* in_1, bool* out_1, bool* inserted) {
	...
	template <typename Node1, typename Node2,
		typename Edge1, typename Edge2,
		typename NodeComparisonFunctor, typename EdgeComparisonFunctor>
		bool VF3State<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, 
			EdgeComparisonFunctor>::NextPair(nodeID_t *pn1, nodeID_t *pn2, nodeID_t prev_n1, nodeID_t prev_n2)
	{
	...
	template <typename Node1, typename Node2,
		typename Edge1, typename Edge2,
		typename NodeComparisonFunctor, typename EdgeComparisonFunctor>
		bool VF3State<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>
